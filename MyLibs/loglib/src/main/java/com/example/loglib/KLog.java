...
public final class KLog {
    ...
    private static final String SUFFIX_AUTO_TEST = "#AutoTest#";
    ...
    public static void apm(String msg) {
        android.util.Log.i("NT2_APM ", msg);
    }
    ...
    public static void forTest(Object msg) {
        printLog(I, null, SUFFIX_AUTO_TEST + msg);
    }

    public static void eforTest(Object msg) {
        printLog(E, null, SUFFIX_AUTO_TEST + msg);
    }
